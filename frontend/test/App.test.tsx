...
import { agentStatus, dailyIncome, income, stubFetch } from "./fakes";
...
describe("App", () => {
  ...
  it("shows the four tabs in order and switches screens on hashchange", async () => {
    stubFetch({ "/api/status": agentStatus(), "/api/events": [], "/api/snapshots": [], "/api/income?hours=24": income(), "/api/income/daily?days=14": dailyIncome() });
